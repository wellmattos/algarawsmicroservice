...
The `manifest.yml` file specifies the name of your application in IBM Cloud, the timeout value during deployment and which services to bind to.

### Run

To build and run the application:
1. `mvn install`
1. `java -jar ./target/algarawsmicroservice-1.0-SNAPSHOT.jar`
